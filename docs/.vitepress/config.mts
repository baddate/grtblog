...
export default defineConfig({
  title: "sanblog",
  description: "sanblog v2 — 现代化静态博客系统文档",
  cleanUrls: true,
  lang: "zh-CN",
  themeConfig: {
    ...
    sidebar: {
      "/guide/": [
        {
          text: "使用指南",
          items: [
            { text: "什么是 sanblog？", link: "/guide/introduction" },
      ...
      "/releases/": [
        {
          text: "版本发布",
          items: [{ text: "发布归档", link: "/releases/" }],
        },
      ],
    },

    socialLinks: [
      { icon: "github", link: "https://github.com/baddate/sanblog-v2" },
    ],
