...
>
	...
	<!-- 装饰线 -->
	<div
		class="z-10 w-[3px] bg-accent-500 opacity-60 transition-all duration-300 group-hover:opacity-100"
	></div>
	...
	<div class="relative z-10 flex flex-1 flex-col justify-center px-6 py-2">
		<div class="mb-1 flex items-center gap-3">
			<span
				class="text-[9px] font-bold tracking-[0.25em] text-accent-600 uppercase dark:text-accent-400"
				>year summary</span
			>
			<div
		...
		<h3
			class="font-serif text-[18px] font-bold tracking-tight text-ink-900 transition-colors group-hover:text-accent-700 dark:text-ink-50 dark:group-hover:text-accent-400 line-clamp-2 break-words"
		>
			{title}
		</h3>
	...
	<!-- 右侧装饰图标 -->
	<div
		class="flex w-16 items-center justify-center border-l border-ink-100/30 text-ink-300 transition-all duration-300 group-hover:bg-accent-50/30 group-hover:text-accent-500 dark:border-ink-800/30 dark:group-hover:bg-accent-950/20"
	>
		<svg
